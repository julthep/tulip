...
session = requests_cache.CachedSession(old_data_on_error=True)
...
def main():
    ...
    # test table
    print('='*70)
    html = read_file('rfc1942_table5.html')
    tulip = parse_html(html)
    turtle = gen_turtle(tulip)
    write_file(turtle, 'rfc1942_table5.pre.ttl')
    add_elem('rfc1942_table5.pre.ttl', 'rfc1942_table5.ttl', 'turtle')
    dump = dump_tulip(tulip)
    write_file(dump, 'rfc1942_table5.txt')
    print('-'*70)
    rdf_text = read_file('rfc1942_table5.ttl')
    tulip_rdf = parse_rdf(rdf_text,'turtle')
    html = gen_html(tulip_rdf)
    write_file(html, 'rfc1942_table5.ttl.html')
    dump = dump_tulip(tulip_rdf)
    write_file(dump, 'rfc1942_table5.ttl.txt')
    # test list
    print('='*70)
    write_file(gen_turtle(parse_html(read_file('rfc1866_list5.html'))), 'rfc1866_list5.pre.ttl')
    write_file(dump_tulip(parse_html(read_file('rfc1866_list5.html'))), 'rfc1866_list5.txt')
    add_elem('rfc1866_list5.pre.ttl','rfc1866_list5.ttl', 'turtle')
    print('-'*70)
    write_file(gen_html(parse_rdf(read_file('rfc1866_list5.ttl'),'turtle')), 'rfc1866_list5.ttl.html')
    write_file(dump_tulip(parse_rdf(read_file('rfc1866_list5.ttl'),'turtle')), 'rfc1866_list5.ttl.txt')
    # test article
